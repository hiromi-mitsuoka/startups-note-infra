# TODO: ディレクトリ構造調整時に、frontend,backendで1つにまとめられたらまとめたい

module "front_describe_regions_for_ec2" {
  source = "./modules/iam_role"
  name = "front-describe-regions-for-ec2"
...
module "front_ecs_task_execution_role" {
  source = "./modules/iam_role"
  name = "front-ecs-task-execution"
